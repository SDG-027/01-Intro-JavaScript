...
const hasNumGreater20 = numbers.some((num) => num > 20);

// console.log(hasNumGreater20);
...
const smaller50 = numbers.every((number) => number < 50);
...
// const someoneFailed = students.some((student) => student.passed === false);
const someoneFailed = students.some((student) => !student.passed);
